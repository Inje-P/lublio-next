      ...
      {chapter == "11" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[10].region}</h3>
      ...
      {chapter == "12" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[11].region}</h3>
      ...
      {chapter == "13" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[12].region}</h3>
      ...
      {chapter == "14" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[13].region}</h3>
      ...
      {chapter == "15" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[14].region}</h3>
      ...
      {chapter == "16" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[15].region}</h3>
      ...
      {chapter == "17" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[16].region}</h3>
      ...
      {chapter == "18" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[17].region}</h3>
      ...
      {chapter == "19" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[18].region}</h3>
      ...
      {chapter == "20" ? (
        <>
          <div className={styles.articleBox}>
            ...
            <h3>{cities_germany[19].region}</h3>
